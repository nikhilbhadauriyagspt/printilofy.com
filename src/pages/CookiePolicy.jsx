...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This Cookie Policy explains how Printilofy LLC ("Company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://printilofy.com/">https://printilofy.com/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@printilofy.com">info@printilofy.com</a></li>
        <li>Visiting: <Link to="/contact">https://printilofy.com/contact</Link></li>
      </ul>
      ...
      <div className="bg-gray-50 p-8 rounded-sm border border-[#e9e9e9] my-8 not-prose">
        <address className="not-italic text-gray-700 font-bold leading-relaxed space-y-2">
          ...
          <p>MM, 1614 Gervais St</p>
          <p>Columbia, SC 29201</p>
          <p>United States</p>
          <p className="pt-4 flex items-center gap-3 text-[#1447E6] font-extrabold">info@printilofy.com</p>
        </address>
      </div>
    </PolicyLayout>
  );
