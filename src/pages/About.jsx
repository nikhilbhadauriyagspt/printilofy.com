    ...
    <div className="bg-[#f5f5f5] min-h-screen font-['Heebo'] text-slate-900 pb-20">
      ...
      <div className="bg-white border-b border-slate-200 py-10 md:py-14 mb-10">
        <div className="w-full px-4 lg:px-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            <nav className="flex items-center gap-2 text-[11px] font-black text-slate-400 capitalize tracking-widest mb-4">
          ...
          <div className="flex items-center gap-2 px-5 py-2.5 bg-blue-50 text-[#4B4DED] rounded-full border border-blue-100">
            ...
            <span className="text-[11px] font-black capitalize tracking-widest">Premium Hardware Partner</span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full px-4 lg:px-12 space-y-20 mt-10">
          ...
          <div className="lg:col-span-7 bg-white p-8 md:p-16 space-y-8 flex flex-col justify-center">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black text-[#4B4DED] capitalize tracking-[0.3em]">The Vision</span>
              </div>
              <h2 className="text-3xl lg:text-5xl font-black text-slate-900 leading-tight capitalize tracking-tighter">Built on trust <br /> <span className="text-slate-300">and precision.</span></h2>
            </div>
            ...
            <div className="pt-4">
              <Link to="/shop" className="inline-flex items-center gap-3 bg-[#4B4DED] text-white px-8 py-4 rounded-full font-black text-[11px] capitalize tracking-widest hover:bg-slate-900 transition-all shadow-lg shadow-blue-900/20">
        ...
        <section className="space-y-12">
          <div className="flex flex-col items-center text-center gap-3">
            <span className="text-[10px] font-black text-[#4B4DED] capitalize tracking-[0.3em]">Operational scope</span>
            <h2 className="text-3xl lg:text-4xl font-black text-slate-900 capitalize tracking-tight">Our core capabilities.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-black text-slate-900 mb-4 capitalize relative z-10">{item.title}</h3>
          ...
          <div className="p-12 md:p-20 bg-slate-900 rounded-[2.5rem] text-white space-y-8 relative overflow-hidden shadow-2xl">
            <div className="relative z-10 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black capitalize tracking-[0.2em] text-blue-300">Our mission</span>
              </div>
              <h3 className="text-3xl md:text-4xl font-black leading-tight capitalize">The customer <span className="text-blue-500">standard.</span></h3>
          ...
          <div className="p-12 md:p-20 bg-white border border-slate-200 rounded-[2.5rem] text-slate-900 space-y-8 relative overflow-hidden shadow-xl shadow-blue-900/5">
            <div className="relative z-10 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black capitalize tracking-[0.2em] text-slate-400">Our community</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-black leading-tight capitalize tracking-tight">Nationwide <span className="text-slate-300">reach.</span></h2>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 border-b border-slate-100 pb-10">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black capitalize tracking-[0.3em] text-[#4B4DED]">Certified ecosystem</span>
              </div>
              <h2 className="text-2xl md:text-4xl font-black text-slate-900 tracking-tight">The Printilofy Advantage</h2>
            </div>
            <Link to="/shop" className="text-[11px] font-black capitalize tracking-widest text-[#4B4DED] border-b-2 border-blue-100 pb-1 hover:border-[#4B4DED] transition-all flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-8 gap-y-12">
            {[
              ...
              <div key={i} className="flex items-center gap-5 group">
                ...
                <h4 className="text-[14px] font-black text-slate-700 group-hover:text-[#4B4DED] transition-colors capitalize tracking-tight">{item.title}</h4>
              </div>
            ))}
          </div>
        </div>
